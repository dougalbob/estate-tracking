...
|                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Live release                       | **v0.2.16** — the pickers, the count and the buttons: every dropdown that lists contacts now shows them A to Z (with each picker's own fixed options kept in place, and the Contacts tab's Added order untouched); the count under a project's title follows that panel's **Hide Done** filter and reads "5 outstanding tasks" rather than the true total, while the **Show Done (n)** button still carries how many are hidden; and the Projects toolbar gained **Collapse all** and **Expand all**, each greyed out when there is nothing left for it to do — built by GitHub Actions and published to GHCR as `v0.2.16`, `latest`, and a git-SHA tag. Until Unraid pulls the new image the server is still running the previous release |
| Earlier releases                   | v0.2.0 – v0.2.15, all published 16–19 September 2026                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| Verified by hand, not in a browser | The v0.2.5, v0.2.6, v0.2.7, v0.2.8, v0.2.9, v0.2.10, v0.2.11, v0.2.12, v0.2.13, v0.2.14, v0.2.15 and v0.2.16 changes were checked by rendering the real components to markup and by HTTP against the development server; the sandbox has no browser, so no click-through test has ever run in one                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Automated gates                    | 162 unit/integration tests, TypeScript, Prettier and the production build all pass on the released commit, and `npm audit --omit=dev` reports 0 findings                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
