...
|                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Live release                       | **v0.2.18** — a cleaner default view and documents that follow the work: a contact's **Linked tasks** and every **project panel** now open with done tasks hidden, with a **Show Done (n)** button that says how many are out of sight and brings them back; and an interaction created from a task with **Create interaction** now inherits the task's documents — linked to the new interaction in the same save, as ordinary links that can be removed by hand — and the task row gains an **Outcome logged** hop to it (migration `0010_interaction_source_task`, one nullable column). This change is tagged `v0.2.18` on the merge commit, which is what makes GitHub Actions publish the image; until Unraid pulls it, the server still runs v0.2.17 |
| Earlier releases                   | v0.2.0 – v0.2.16, all published 16–19 September 2026                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| Verified by hand, not in a browser | The v0.2.5, v0.2.6, v0.2.7, v0.2.8, v0.2.9, v0.2.10, v0.2.11, v0.2.12, v0.2.13, v0.2.14, v0.2.15, v0.2.16, v0.2.17 and v0.2.18 changes were checked by rendering the real components to markup and by HTTP against the development server; the sandbox has no browser, so no click-through test has ever run in one                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Automated gates                    | 179 unit/integration tests, TypeScript, Prettier and the production build all pass on the released commit, and `npm audit --omit=dev` reports 0 findings                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
