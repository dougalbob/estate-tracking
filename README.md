...
|                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| ---------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Live release                       | **v0.2.10** — a Sort menu and a **Hide resolved** filter on the contacts list, a type, a **Task Outcome** and a **Create interaction** button on the task, an **Everyone** assignee for work the two users share, and the Waiting status renamed to Scheduled — built by GitHub Actions and published to GHCR as `v0.2.10`, `latest`, and a git-SHA tag. Until Unraid pulls the new image the server is still running **v0.2.9** |
| Earlier releases                   | v0.2.0 – v0.2.9, all published 16–19 September 2026                                                                                                                                                                                                                                                                                                                                                                              |
...
| Verified by hand, not in a browser | The v0.2.5, v0.2.6, v0.2.7, v0.2.8, v0.2.9 and v0.2.10 changes were checked by rendering the real components to markup and by HTTP against the development server; the sandbox has no browser, so no click-through test has ever run in one                                                                                                                                                                                      |
| Automated gates                    | 94 unit/integration tests, TypeScript, Prettier and the production build all pass on the released commit                                                                                                                                                                                                                                                                                                                         |
