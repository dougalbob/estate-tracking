...
|                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| ---------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Live release                       | **v0.2.12** — a full-page **Calendar** tab showing every task with a due date by month or by week, colour coded by project, with status and assignee checkboxes, a search box, click to open the task and drag to another day — built by GitHub Actions and published to GHCR as `v0.2.12`, `latest`, and a git-SHA tag. Until Unraid pulls the new image the server is still running **v0.2.11** |
| Earlier releases                   | v0.2.0 – v0.2.11, all published 16–19 September 2026                                                                                                                                                                                                                                                                                                                                                                             |
...
| Verified by hand, not in a browser | The v0.2.5, v0.2.6, v0.2.7, v0.2.8, v0.2.9, v0.2.10, v0.2.11 and v0.2.12 changes were checked by rendering the real components to markup and by HTTP against the development server; the sandbox has no browser, so no click-through test has ever run in one                                                                                                                                                                                     |
| Automated gates                    | 112 unit/integration tests, TypeScript, Prettier and the production build all pass on the released commit                                                                                                                                                                                                                                                                                                                         |
