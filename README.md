...
|                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| ---------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Live release                       | **v0.2.11** — a collapse/expand control and a **Hide Done** filter on each project panel, and a **Hide Done/Scheduled** filter on the tasks list — built by GitHub Actions and published to GHCR as `v0.2.11`, `latest`, and a git-SHA tag. Until Unraid pulls the new image the server is still running **v0.2.10** |
| Earlier releases                   | v0.2.0 – v0.2.10, all published 16–19 September 2026                                                                                                                                                                                                                                                                                                                                                                             |
...
| Verified by hand, not in a browser | The v0.2.5, v0.2.6, v0.2.7, v0.2.8, v0.2.9, v0.2.10 and v0.2.11 changes were checked by rendering the real components to markup and by HTTP against the development server; the sandbox has no browser, so no click-through test has ever run in one                                                                                                                                                                                     |
