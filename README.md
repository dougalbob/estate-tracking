...
|                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Live release                       | **v0.2.20** — subtle version at bottom of workspace navigation (PC and mobile), backup filename carries version and 24h London time `estate-backup-v0.2.20-YYYY-MM-DD-HHmm.estate-backup` to avoid overwrites and identify release for rollback, and `appVersion` recorded in `BackupMetadata` manifest. This change is tagged `v0.2.20` on the merge commit, which is what makes GitHub Actions publish the image; until Unraid pulls it, the server still runs v0.2.19 |
| Earlier releases                   | v0.2.0 – v0.2.18, all published 16–20 September 2026                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| Automated gates                    | 188 unit/integration tests, TypeScript, Prettier and the production build all pass on the released commit, and `npm audit --omit=dev` reports 0 findings                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
