...
- A form opened from another form is a **fresh form**. Choosing **+ New contact…** and then creating the interaction used to leave the new note's dropdown offering to create the contact again, and re-using the contact, follow-ups or version of the task that had just been saved; the editor is now keyed so a new record always starts clean, and a contact saved a moment ago is named in the dropdown from the moment the form opens rather than after the next refresh lands.
