...
|                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Live release                       | **v0.2.14** — the review-driven fix release: permanently deleting an organisation or project with linked financial records no longer fails, one shared file-type list governs the share target, both upload paths and the file picker (so a HEIC with a missing MIME type uploads), SVG files are refused, calendar tasks move with the arrow keys, the All tasks assignee filter reads plainly, link dropdowns are no longer truncated at 100, dialogs return focus to the button that opened them, and the document screens speak plain English instead of server diagnostics — built by GitHub Actions and published to GHCR as `v0.2.14`, `latest`, and a git-SHA tag. Until Unraid pulls the new image the server is still running the previous release |
| Earlier releases                   | v0.2.0 – v0.2.13, all published 16–19 September 2026                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| Verified by hand, not in a browser | The v0.2.5, v0.2.6, v0.2.7, v0.2.8, v0.2.9, v0.2.10, v0.2.11, v0.2.12, v0.2.13 and v0.2.14 changes were checked by rendering the real components to markup and by HTTP against the development server; the sandbox has no browser, so no click-through test has ever run in one                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| Automated gates                    | 125 unit/integration tests, TypeScript, Prettier and the production build all pass on the released commit                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
