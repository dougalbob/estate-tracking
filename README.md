...
|                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Live release                       | **v0.2.17** — the readable journal: a project panel now shows one chronological list of that project's interactions, documents and tasks, most recent first, instead of its tasks alone, so the panel tells the story of the project rather than only what is left to do; an interaction is shown as a card whose **full detail leads** and whose title never appears on any card (the title stays a quiet handle in the editor, the pickers, search, the history and the bin); and a document can carry the **date printed on the paper**, so a house deed from 1987 sits where it belongs in that story rather than at the top of it. This change is tagged `v0.2.17` on the merge commit, which is what makes GitHub Actions publish the image; until Unraid pulls it, the server still runs v0.2.16 |
...
| Verified by hand, not in a browser | The v0.2.5, v0.2.6, v0.2.7, v0.2.8, v0.2.9, v0.2.10, v0.2.11, v0.2.12, v0.2.13, v0.2.14, v0.2.15, v0.2.16 and v0.2.17 changes were checked by rendering the real components to markup and by HTTP against the development server; the sandbox has no browser, so no click-through test has ever run in one                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Automated gates                    | 174 unit/integration tests, TypeScript, Prettier and the production build all pass on the released commit, and `npm audit --omit=dev` reports 0 findings                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
- Each project has a **Hide Done** filter that hides tasks whose status is Done in that project. When off it reads **Hide Done**, when on **Show Done (2)** with the count of done tasks in that project, using the same Eye/EyeOff, variant and `aria-pressed` pattern as the contacts **Hide resolved** filter. The count under the title follows the filter: off it reads the true total (“7 tasks”), on it counts what is left and says “5 outstanding tasks”, so a smaller number reads as filtered rather than as tasks gone missing — and the **Show Done (n)** button still says how many are hidden. Both counts pluralise properly (“1 task”, “1 outstanding task”), a project with no tasks reads “0 tasks” either way, and the organisations and docs counts are never affected, because Hide Done is a task filter only. When every task in a project is done and hidden, the journal's empty state reads “Every task in this project is done, so the list is empty while done tasks are hidden.”; a project with nothing in it at all reads “Nothing has happened in this project yet.”
