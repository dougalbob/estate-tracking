...
|                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Live release                       | **v0.2.15** — the balance, the memory and the single copy: the movement dialog shows what a payment or reimbursement leaves still owed while the amount is typed, and switches **Record** off before an over-amount is submitted; the Event log's filters are remembered in that browser, validated against the contacts and projects that still exist so a deleted one falls back to "All"; and the fifteen copies of the action boilerplate, the two copies of the upload rule and the hand-copied file-picker lists are each one copy now — which is also why a receipt picker stopped hiding HEIC files and offering SVGs, and why upload failures stopped quoting `df -h` at a non-developer — built by GitHub Actions and published to GHCR as `v0.2.15`, `latest`, and a git-SHA tag. Until Unraid pulls the new image the server is still running the previous release |
| Earlier releases                   | v0.2.0 – v0.2.14, all published 16–19 September 2026                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| Verified by hand, not in a browser | The v0.2.5, v0.2.6, v0.2.7, v0.2.8, v0.2.9, v0.2.10, v0.2.11, v0.2.12, v0.2.13, v0.2.14 and v0.2.15 changes were checked by rendering the real components to markup and by HTTP against the development server; the sandbox has no browser, so no click-through test has ever run in one                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| Automated gates                    | 159 unit/integration tests, TypeScript, Prettier and the production build all pass on the released commit, and `npm audit --omit=dev` reports 0 findings                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
