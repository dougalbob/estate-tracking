...
|                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Live release                       | **v0.2.19** — "Family & friends" call sheet and funeral guest list: a dense, keyboard-driven spreadsheet grid on PC for rapid data entry, and a call sheet on mobile with one-tap dialing and contacted ticks; separate `households` and `gatherings` tables (migration `0011_guest_list`), per-cell auto-save, summary strip for headcounts and catering, recoverable bin and audit integration, with zero leakage into contacts or journal. This change is tagged `v0.2.19` on the merge commit, which is what makes GitHub Actions publish the image; until Unraid pulls it, the server still runs v0.2.18 |
...
| Verified by hand, not in a browser | The v0.2.5, v0.2.6, v0.2.7, v0.2.8, v0.2.9, v0.2.10, v0.2.11, v0.2.12, v0.2.13, v0.2.14, v0.2.15, v0.2.16, v0.2.17, v0.2.18 and v0.2.19 changes were checked by rendering the real components to markup and by HTTP against the development server; the sandbox has no browser, so no click-through test has ever run in one                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Automated gates                    | 187 unit/integration tests, TypeScript, Prettier and the production build all pass on the released commit, and `npm audit --omit=dev` reports 0 findings                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
