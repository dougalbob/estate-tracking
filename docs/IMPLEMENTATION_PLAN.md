...
| Item                   | Position today                                                                                                                                                                                                                                                                                                                                                                                                |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Live release           | **v0.2.10** (a Sort menu and a Hide resolved filter on the contacts list, a type, a Task Outcome and a Create interaction button on the task, an Everyone assignee for work the two users share, and the Waiting status renamed to Scheduled), built by GitHub Actions and published to GHCR; v0.2.0–v0.2.9 preceded it on 16–19 September 2026, and v0.2.9 is what the server runs until the image is pulled |
