...
| Item                   | Position today                                                                                                                                                                                                                                                                                                                                                                                                |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Live release           | **v0.2.11** (a collapse/expand control and a Hide Done filter on each project panel, and a Hide Done/Scheduled filter on the tasks list), built by GitHub Actions and published to GHCR; v0.2.0–v0.2.10 preceded it on 16–19 September 2026, and v0.2.10 is what the server runs until the image is pulled |
...
| Automated gates        | **94 unit/integration tests**, `tsc --noEmit`, `prettier --check` and `next build` all pass on the released commit                                                                                                                                                                                                                                                                                            |
...
| Version numbering      | The next release after v0.2.11 is v0.2.12. Tags are the version source of truth; `package.json` is kept in step for tidiness                                                                                                                                                                                                                                                                                  |
