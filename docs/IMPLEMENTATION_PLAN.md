...
| Item                   | Position today                                                                                                                                                                                                                                                                                                                                                                                                |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Live release           | **v0.2.12** (a full-page Calendar tab over every task with a due date: month and week views, colour coded by project, status and assignee checkboxes, a search box, click to open the task, and drag to another day), built by GitHub Actions and published to GHCR; v0.2.0–v0.2.11 preceded it on 16–19 September 2026, and v0.2.11 is what the server runs until the image is pulled |
...
| Automated gates        | **112 unit/integration tests**, `tsc --noEmit`, `prettier --check` and `next build` all pass on the released commit                                                                                                                                                                                                                                                                                            |
...
| Version numbering      | The next release after v0.2.12 is v0.2.13. Tags are the version source of truth; `package.json` is kept in step for tidiness                                                                                                                                                                                                                                                                                  |
